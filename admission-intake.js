...
const start=document.createElement('button');start.type='button';start.textContent='Admission enquiry';start.style.cssText='margin:8px;padding:12px;border-radius:12px;background:#071b52;color:white;border:0';host.insertBefore(start,host.querySelector('form'));
